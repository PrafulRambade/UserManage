                    ...
                    <tbody id="example222">
                        ...
                        @foreach ($userDetails as $user)
                            ...
                            <tr>
                                ...
                                <td><a class="edit-user btn btn-primary btn-sm" id="{{$user->id}}" data-toggle="modal" data-target="#EditModalForm">Edit</button></td>
                                <td><a href="javascript:void(0)" id="{{$user->id}}" class="delete btn btn-danger btn-sm">Delete</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
